...
export default function Contact() {
  const { hasCopied, onCopy } = useClipboard('anesurirwa@outlook.com')
            ...
            <Stack
              ...
              <Show below='md'>
                <Stack
                  ...
                  <Box as="a" href="https://github.com/anesu-rirwa/">
                    <IconButton
                      aria-label="github"
                      variant="ghost"
                      size="lg"
                  ...
                  <Box as="a" href="www.linkedin.com/in/anesurirwa">
                    <IconButton
                      aria-label="linkedin"
                      variant="ghost"
                      size="lg"
              ...
              <Box
                ...
                shadow="base">
                <VStack spacing={5}>
                  <Flex flexDirection={{base: 'column', lg: 'row'}} justify={'space-between'}  border={'solid red thin'}>
